...
from typing import Optional, Text, Any, Dict, Callable, Awaitable
...
class UnityIO(InputChannel):
    ...
    async def on_message_wrapper(
        ...
        await queue.put("DONE")  # py-type: disable=bad-return-type
    ...
    def stream_response(
        ...
        async def stream(resp: Any) -> None:
            ...
            result = None  # declare variable up front to avoid py-type error
            while True:
                result = await q.get()
                if result == "DONE":
                    break
        ...
        return stream  # py-type: disable=bad-return-type
